...
Використовується у server/app.py (AI-чат на дошці) — перетворює
вільний текст, який написала людина ("Антверпен", "Мерксем"), на
поштові індекси для одноразового пошуку.
"""
